    ...
    <div className="modal-overlay">
      <div className="modal-content max-w-4xl">
        <div className="modal-header">
          <h2>{record ? 'Editar Registro' : 'Novo Serviço Realizado'}</h2>
          ...
          <form onSubmit={handleSubmit} className="form-grid">
            ...
            <div className="form-group col-span-2">
              ...
              <div className="input-group">
                ...
                <input 
                  type="text" 
                  placeholder="Ex: Lavagem + Polimento" 
            ...
            <div className="form-group col-span-2">
              ...
              <div className="input-group" style={{ alignItems: 'flex-start' }}>
                <MessageSquare size={18} color="var(--text-muted)" style={{ marginTop: '0.5rem' }} />
                <textarea 
                  placeholder="Notas para a equipe ou histórico do serviço..." 
